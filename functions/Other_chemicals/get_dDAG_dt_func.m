...
other_degrade = theta('b_DAG_degrade_2');
if c_cyto > 0.05
    time_deri_DAG = b_IP3 * Hill_func(PLC, 1, K_IP3_DAG_prod) - b_DAG_degrade * Hill_func(c_cyto, 2, theta('K_DAG_degrade_1')) * Hill_func(DAG, 2, theta('K_DAG_degrade_2')) - other_degrade * DAG;
else
