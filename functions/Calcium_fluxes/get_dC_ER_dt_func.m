...
function dC_ER_dt_func = get_dC_ER_dt_func(theta, cyto_ER_ratio, other_settings)
b_ER = theta('b_ER');
...
dC_ER_dt_func = @(c_cyto, c_ER, ATP, IP3, PKA_particle, init_c_ER, ROS_cyto) cyto_ER_ratio * (- b_ER * FER_func(c_cyto, c_ER, ATP, IP3, PKA_particle, ROS_cyto) ...
