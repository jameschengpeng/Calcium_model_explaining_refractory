...
aqua_data_path = fullfile(data_path, mouse_name, loc, data_dir, strcat(data_dir, '.mat'));
fps_upsampled = 50;
fps_org = 30;
...
%%
[chemical_table, flux_table] = run_RK4(theta, other_settings, abs(run_seq), NE_spont, running_threshold, fps_org, fps_upsampled, ...
